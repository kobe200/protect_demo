...
public class ThumbnailUtil {
     ...
     * @throws Exception
     */
    public static Bitmap getThumbnailBitmap(Context context, MediaItemInfo mediaItem, int w, int h)
            throws Exception {
        Log.d(TAG,
     ...
     * @throws Exception
     */
    public static Bitmap getThumbnailBitmap(Context context, MediaItemInfo mediaItem, int kind)
            throws Exception {
