...
public class CacheDataUtil {
	private static final String SHARED_PREFERENCES_CACHE_FILE = "car_video_sdk_cache_file";
	...
	public String getData(String cacheKey) {
		...
		try {
			...
			LogUtils.print(TAG, "getData():Exception");
		}
		return data;
	}
	...
	public long getLongData(String cacheKey) {
		...
		try {
			...
			LogUtils.print(TAG, "getLongData():Exception");
		}
		return data;
	}
	...
	public int getIntData(String cacheKey, int def) {
		...
		try {
			...
			LogUtils.print(TAG, "getIntData():Exception");
		}
		return data;
	}
	...
	public boolean getBoolData(String cacheKey, boolean defValue) {
		...
		try {
			...
			LogUtils.print(TAG, "getBoolData():Exception" + e.getMessage());
		}
		return data;
	}
	...
	public boolean deleteDataFile(String fileName) {
		try {
			...
			LogUtils.print(TAG, "deleteDataFile()::Exception");
		}
		return false;
	}
}
