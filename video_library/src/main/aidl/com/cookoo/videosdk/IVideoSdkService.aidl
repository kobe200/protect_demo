...
interface IVideoSdkService {
         ...
         int getTotalTime();
           ...
           * @param mediaItemInfo
           */
          void playVideo(in MediaData mediaItemInfo);
           ...
           * @param usbPath
           */
          void clearUsbVideo(in String usbPath);
         ...
         boolean isCurrentDeviceScanFinished(in String usbPath);
          ...
          /**
            ...
            * @param usbPath
            */
           void handleVideoDataChange(in String usbPath);
            ...
            */
          void requestVideoData(in String path, int dataType);
        ...
        int getSavePlayProgress();
          ...
          /**
            ...
            * @return
            */
          MediaItemInfo getMediaItemInfo(in String filePath);
         ...
         /**
           ...
           */
         void setVideoPosition(in int[] videoPosition);
         ...
         /**
           ...
           */
          String getUsbRootPathByFilePath(in String filePath);
       ...
       /***注册callback**/
       boolean registerVideoServiceCallback(IVideoServiceCallback cb);

       /**反注册callback**/
       boolean unregisterVideoServiceCallback(IVideoServiceCallback cb);
