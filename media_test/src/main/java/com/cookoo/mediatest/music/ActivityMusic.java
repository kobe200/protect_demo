package com.cookoo.mediatest.music;
...
import com.cookoo.mediatest.common.BaseViewHolder;
import com.cookoo.mediatest.common.CommonAdapter;
...
import com.cookoo.musicsdk.utils.ThumbnailUtil;
...
public class ActivityMusic extends BaseActivity implements MusicStateListener, OnClickListener, OnItemClickListener {
    ...
    private void initListener() {
        ...
        findViewById(R.id.btn_start_extend_music).setOnClickListener(this);
    ...
    public void onMusicStateChanged(int eventId) {
        switch(eventId) {
            ...
            case MusicSdkConstants.MusicStateEventId.MUSIC_PLAY_ERROR:
                LogUtils.print(TAG,"------>>>musicStateChanged() MUSIC_PLAY_ERROR");
    ...
    public void onClick(View v) {
        switch(v.getId()) {
            ...
            case R.id.btn_playlist_collected:
                ...
                break;
            case R.id.btn_start_extend_music:
                Intent intent = new Intent("start.extend.music.action");
                intent.setPackage("com.cookoo.extendmusic");
