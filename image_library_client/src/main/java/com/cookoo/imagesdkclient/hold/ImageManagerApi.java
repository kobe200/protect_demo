package com.cookoo.imagesdkclient.hold;
...
public interface ImageManagerApi {
     ...
     */
    void requestImageData(String path, int dataType);

    /**
     * 当数据改变的时候，需要调用这个方法进行更新获取相应数据
     * @param usbPath 表示获取对应usb的相应数据
     */
    void handleImageDataChange(String usbPath);
     ...
     * @param photoView
     */
    void setCurrentPhotoView(PhotoView photoView);
